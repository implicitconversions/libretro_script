...
typedef struct hc_DebuggerIf {
    ...
    struct {
        ...
        void (* const handle_event)(void* frontend_user_data, hc_SubscriptionID subscription_id, hc_Event const* event);
        
        /* Tells the core to report certain events. Returns negative value if not supported or if an error occurred */
        hc_SubscriptionID (* subscribe)(hc_Subscription const* subscription);
        void (* unsubscribe)(hc_SubscriptionID subscription_id);
    }
    v1;
}
hc_DebuggerIf;
...
#define HC_CPU_R3000A HC_MAKE_CPU_TYPE(3, 1)

#define HC_R3000A_R0 0
#define HC_R3000A_AT 1
#define HC_R3000A_V0 2
#define HC_R3000A_V1 3
#define HC_R3000A_A0 4
#define HC_R3000A_A1 5
#define HC_R3000A_A2 6
#define HC_R3000A_A3 7
#define HC_R3000A_T0 8
#define HC_R3000A_T1 9
#define HC_R3000A_T2 10
#define HC_R3000A_T3 11
#define HC_R3000A_T4 12
#define HC_R3000A_T5 13
#define HC_R3000A_T6 14
#define HC_R3000A_T7 15
#define HC_R3000A_S0 16
#define HC_R3000A_S1 17
#define HC_R3000A_S2 18
#define HC_R3000A_S3 19
#define HC_R3000A_S4 20
#define HC_R3000A_S5 21
#define HC_R3000A_S6 22
#define HC_R3000A_S7 23
#define HC_R3000A_T8 24
#define HC_R3000A_T9 25
#define HC_R3000A_K0 26
#define HC_R3000A_K1 27
#define HC_R3000A_GP 28
#define HC_R3000A_SP 29
#define HC_R3000A_FP 30
#define HC_R3000A_RA 31
#define HC_R3000A_PC 32
#define HC_R3000A_LO 33
#define HC_R3000A_HI 34

#define HC_R3000A_NUM_REGISTERS 35
